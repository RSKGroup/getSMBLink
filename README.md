...
The automator file needs to be added to ~/Library/Services.  Then you can right click a file or folder on a file share and in the menu, select Quick Actions -> Get smb link.
